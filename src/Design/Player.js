...
export function player() {
  ...
  // function addShipRandomly() {
  //   let availableSquares = playerBoard.Board;

  //   ships.forEach((shipLength) => {
  //     const shipRotation = getRandomRotation()
  //     const constructed_ship = battleShip(
  //       shipLength,
  //       (availableSquares = availableSquares.filter(
  //         removeCloseSquares(shipLength, shipRotation)
  //       )[availableSquares].length),
  //       shipRotation
  //     );
  //     addShip(constructed_ship);
  //   });
  // }
  return {
    isWinner,
